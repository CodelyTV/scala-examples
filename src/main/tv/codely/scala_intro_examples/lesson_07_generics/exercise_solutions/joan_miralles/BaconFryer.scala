...
import tv.codely.scala_intro_examples.lesson_07_generics.exercise_solutions.joan_miralles.Ingredients.{
  Bacon,
  FriedBacon
}
...
final class BaconFryer(implicit ec: ExecutionContext) extends Fryer[Bacon, FriedBacon] {
